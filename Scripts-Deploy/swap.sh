...
read TAMANIO_PAGINA
echo "INGRESE EL RETARDO DEL PROCESO SWAP"
read RETARDO_SWAP
echo "INGRESE EL RETARDO DE LA COMPACTACION"
read RETARDO_COMPACTACION


echo "PUERTO_ESCUCHA=$PTO_MEMORIA">>  $GIT_TP_LOC/$ADMIN_SWAP/Admin-Swap.config
...
echo "RETARDO_SWAP=$RETARDO_SWAP">> $GIT_TP_LOC/$ADMIN_SWAP/Admin-Swap.config
